...
class LLMWrapper:
    ...
    def bind_tools(self, tools: Sequence[BaseTool]) -> Runnable:  # type: ignore[reportMissingTypeArgument]
        return self._chat_model.bind_tools(tools)  # type: ignore[reportUnknownMemberType]

    def with_structured_output(self, schema: type[BaseModel]) -> Runnable:  # type: ignore[reportMissingTypeArgument]
        kwargs: dict[str, Any] = {}
